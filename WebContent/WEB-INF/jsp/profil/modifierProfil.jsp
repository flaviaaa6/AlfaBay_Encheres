				...
				<div class="row">
					<div class="col-md-6 mb-3">
						<label for="pseudo">Pseudo</label> <input type="text"
							...
							placeholder="${utilisateurCnx.pseudo }" maxlength="30" required
							value="${utilisateurCnx.pseudo }">
					...
					<div class="col-md-6 mb-3">
						<label for="lastname">Nom</label> <input type="text"
							...
							placeholder="${utilisateurCnx.nom }"
							value="${utilisateurCnx.nom }" maxlength="30" required>
						<div class="invalid-feedback">Ce champ est invalide !</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-6 mb-3">
						<label for="firstname">Prénom</label> <input type="text"
							...
							placeholder="${utilisateurCnx.prenom }"
							value="${utilisateurCnx.prenom }" maxlength="30" required>
						<div class="invalid-feedback">Ce champ est invalide !</div>
					</div>
					...
					<div class="col-md-6 mb-3">
						<label for="email">Email</label> <input type="email"
							...
							placeholder="${utilisateurCnx.email }"
							value="${utilisateurCnx.email }" maxlength="20" required>
						<div class="invalid-feedback">Ce champ est invalide !</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-4 mb-3">
						...
						<input type="text" class="form-control" id="phone" name="phone"
							placeholder="${utilisateurCnx.telephone }"
							value="${utilisateurCnx.telephone }" maxlength="15">
					</div>
					<div class="col-md-8 mb-3">
						<label for="street">Rue</label> <input type="text"
							class="form-control" id="street" name="street"
							placeholder="${utilisateurCnx.rue }"
							value="${utilisateurCnx.rue }" maxlength="30" required>
						<div class="invalid-feedback">Ce champ est invalide !</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-4 mb-3">
						<label for="zipcode">Code postal</label> <input type="number"
							...
							placeholder="${utilisateurCnx.codePostal }" min="01000"
							max="99999" value="${utilisateurCnx.codePostal }" required>
						<div class="invalid-feedback">Ce champ est invalide !</div>
					</div>
					<div class="col-md-8 mb-3">
						<label for="city">Ville</label> <input type="text"
							class="form-control" id="city" name="city"
							placeholder="${utilisateurCnx.ville }" maxlength="30"
